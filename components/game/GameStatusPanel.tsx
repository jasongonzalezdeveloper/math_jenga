...
export function GameStatusPanel({
    ...
    return (
        <div className="fixed inset-x-0 bottom-0 z-20 flex justify-center px-3 pb-3 pt-2 lg:absolute lg:top-1/2 lg:left-0 lg:inset-x-auto lg:bottom-auto lg:w-[30%] lg:-translate-y-1/2 lg:justify-start lg:px-0 lg:pb-0 lg:pt-0">
            <div className="relative w-full max-w-sm rounded border border-zinc-300 bg-white p-3 text-left text-black shadow-sm lg:max-w-xs lg:p-4">
                <button
                    type="button"
                ...
                <div className="flex items-center justify-between gap-2 pr-10 lg:block lg:pr-0">
                    ...
                    <button
                        type="button"
                        onClick={onRotate}
                        className="inline-flex shrink-0 items-center gap-1 rounded bg-blue-600 px-3 py-1.5 text-sm text-white hover:bg-blue-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 lg:mt-4 lg:gap-2 lg:px-4 lg:py-2"
